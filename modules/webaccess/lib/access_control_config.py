...
CFG_ACC_ACTIVITIES_URLS = {
    ...
    'cfgoaiharvest' : (_("Configure OAI Harvest"), "%s/admin2/oaiharvest?ln=%%s" % CFG_SITE_URL),
    'cfgoairepository' : (_("Configure OAI Repository"), "%s/admin2/oairepository?ln=%%s" % CFG_SITE_URL),
