...
def cli_upload(req, file_content=None, mode=None, callback_url=None, nonce=None, special_treatment=None, ignore_strong_tags=False):
...
def metadata_upload(req, metafile=None, filetype=None, mode=None, exec_date=None,
                    exec_time=None, metafilename=None, ln=CFG_SITE_LANG, priority="1",
                    ignore_strong_tags=False, email_logs_to=None):
    """
...
def document_upload(req=None, folder="", matching="", mode="", exec_date="", exec_time="", ln=CFG_SITE_LANG, priority="1", email_logs_to=None):
    ...
    for docfile in files:
        if os.path.isfile(os.path.join(folder, docfile)):
            ...
            task_arguments = ('bibupload', user, "--" + mode, "--ignore-strong-tags", "--name=" + docfile, "--priority=" + priority)
